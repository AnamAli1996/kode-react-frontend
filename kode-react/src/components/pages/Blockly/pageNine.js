            ...
            <Grid container stackable verticalAlign='middle'>
                <Grid.Row>
                    <Grid.Column  width={18}>
                        <Header as='h3' textAlign="centered" style={{ fontSize: '2em' , color: "black"}}>Welcome to the part 2!</Header>
                        <Image src="https://media.giphy.com/media/S80aZMkLElnDW/giphy.gif" centered size="small"/>
                        <Header as='h3' textAlign="centered" style={{ fontSize: '2em' , color: "black"}}>Well you used integers and css to create a traffic light </Header>
                        <Header as='h3' textAlign="centered" style={{ fontSize: '2em', color: "black" }}>but what's a traffic light without it's function</Header>
                        <p style={{ textAlign:"center", fontWeight: 'bold', color: "black", fontSize: '1.33em' }}>
                            Lets put some javascript into it and figure out the logic off how the traffic light works!
                        </p>
                        <p style={{ textAlign:"center", fontWeight: 'bold', color: "black", fontSize: '1.33em' }}>
                           Remember, whatever blocks we pick, we write it in javascript behind the scenes
                        </p>
                        <p style={{ textAlign:"center", fontWeight: 'bold', color: "black", fontSize: '1.33em' }}>
                            Follow the pattern of traffic lights in the next exercise and let's give some commands to the traffic lights
                        </p>
                        <p style={{ textAlign:"center", fontWeight: 'bold', color: "black", fontSize: '1.33em' }}>
                            ...
                            <p>
                                <br />
                                <Button inverted color='black' onClick={onClick()} href="/TrafficLightSequence.html" content='Go!' />
                            </p>
                        </p>
                    </Grid.Column>
                </Grid.Row>
...
function onClick(){
    ...
    localStorage.setItem("studentProgress", "/TrafficLightSequence.html");
