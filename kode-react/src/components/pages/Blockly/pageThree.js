...
const HomepageHeading = ({ mobile }) => (
    ...
    <Container text style={{backgroundImage: "url('https://media.giphy.com/media/I3JazteAZsWI0/giphy.gif')"}}>
        ...
        />
        <Image src="https://media.giphy.com/media/2tRpAPkOOSPhdFkWBX/giphy.gif" centered size="small"/>
    </Container>
            ...
            <Grid container stackable verticalAlign='middle'>
                <Grid.Row>
                    <Grid.Column  width={18}>
                        <Header as='h3' textAlign="centered" style={{ fontSize: '2em' , color: "black"}}>Congratulations, you used CSS!</Header>
                        <p style={{color: "black",  fontSize: '1.33em', textAlign:"center" }}>
                            Let's do more more CSS!
                        </p>
                        <Header as='h3' textAlign="centered" style={{ fontSize: '2em', color: "black" }}>More Shapes!</Header>
                        <p style={{ textAlign:"center", fontWeight: 'bold', color: "black", fontSize: '1.33em' }}>
                            Lets make more shapes! Keep an eye on the shapes, you will use them later on!
                            <p>
                                <br />
                                <Button inverted color='black' onClick={onClick()} href="/DrawBlockly.html" content='Lets Go!' />
                            </p>
                        </p>
                    </Grid.Column>
                </Grid.Row>
...
function onClick(){
    ...
    localStorage.setItem("studentProgress", "DrawBlockly.html");
